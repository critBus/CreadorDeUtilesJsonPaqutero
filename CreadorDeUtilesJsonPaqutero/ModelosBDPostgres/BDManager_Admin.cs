...
public class BDManager_Admin:I_BD_AdminPosgres{
		public string database;
		public string host;
		public string user;
		public string password;
		public string port;
		public BDManager_Admin():
				this("BDManager","localhost","5432","postgres","postgres")
		{
		}
		public BDManager_Admin(string database,string host = "localhost",string port = "5432",string user = "postgres",string password = "postgres"){
		if (database==null){
			this.database="BDManager";
		}else{
		...
		this.BD =BDConexion.getConexion_POSTGRES(this.database,this.user,this.password,this.host,this.port);
